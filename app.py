...
#     # Remove asterisks and other specified symbols
#     cleaned_text = re.sub(r'[!@#$%^&*(),.?":{}|<>*]', '', text)  # Remove specified symbols
...
def text_to_speech(text, lang='eng'):
    """Convert the assistant's response to audio in English using gTTS."""
...
def qa_ret(qdrant_store, input_query):
    ...
    try:
        ...
        template = """
        You’re the personal assistant for GinTrust Bank, here to guide clients through our services with enthusiasm, wit, and a helpful spirit. Speak in the first person, as though you’re part of the team, and use a friendly and welcoming tone.
        Respond in a courteous and professional manner.
        **Note:** Always provide your responses in English to maintain the preferred language format.
        {context}
        **Question:** {question}
        """
...
""", unsafe_allow_html=True)
    ...
    # Subheader
    st.subheader(
        "Upload a document, ask questions, and get responses in both text and audio form in English.")
    st.write("This app allows you to interact with documents in English. It uses advanced NLP to process documents, allowing you to ask questions and get detailed answers in English, both in text and audio format.")
    ...
    **How to Use:**
    ...
    2. Once processed, ask your question in English by typing or using voice input.
    3. Get responses in text and audio form (in English).
